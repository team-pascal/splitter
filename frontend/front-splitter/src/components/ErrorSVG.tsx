...
export function ErrorSVG({ style, color }: Props) {
  return (
    <svg
      version='1.1'
      id='_x32_'
    ...
    >
      ...
      <g>
        <path
          d='M256.007,357.113c-16.784,0-30.411,13.613-30.411,30.397c0,16.791,13.627,30.405,30.411,30.405
          s30.397-13.614,30.397-30.405C286.405,370.726,272.792,357.113,256.007,357.113z'
          fill={color}
        ></path>
        <path
          d='M505.097,407.119L300.769,53.209c-9.203-15.944-26.356-25.847-44.777-25.847
        ...
        ></path>
        <path
          d='M256.007,152.719c-16.784,0-30.411,13.613-30.411,30.405l11.68,137.487c0,10.346,8.378,18.724,18.731,18.724
