...
func (rl ReplacementLessor) MarshalJSON() ([]byte, error) {
...
var _ bun.BeforeAppendModelHook = (*ReplacementLessor)(nil)

func (rl *ReplacementLessor) BeforeAppendModel(ctx context.Context, query bun.Query) error {
	switch query.(type) {
